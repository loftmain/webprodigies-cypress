    ...
    md:items-center"
      ...
      >
        ...
        <TitleSection
          ...
          subheading="Capture your ideas, thoughts, and metting notes in a structured and organized manner."
          pill="Features"
        />
        <div
          className="mt-10
        ...
        >
          ...
          {[...Array(2)].map((arr, index) => (
            <div
              key={randomUUID()}
              className={twMerge(
                clsx("mt-10 flex flex-nowarp gap-6 self-start", {
          ...
          {PRICING_CARDS.map((card) => (
            <CustomCard
              ...
              className={clsx(
                ...
                {
                  "border-brand/brand-primaryPurple/70":
                  ...
                  {card.planType === PRICING_PLANS.proplan && (
                    <>
                      <div
                        ...
                        absolute
                        bg-brand/brand-primaryPurple/80
                        -z-10
                        top-0
                        "
                      ></div>
